                        ...
                        <a href="{{ route('profile') }}">
                            ...
                            @endif
                                ...
                                @if(auth()->user()->isOnline() == true)
                                    <span class="logged-in" style="position: relative; top: 32px; right: 19px; font-size: 21px; color: #5BE38F;">●</span>
                                @elseif(auth()->user()->isOnline() != true)
                                    <span class="logged-out" style="position: relative; top: 32px; right: 19px; font-size: 21px; color: darkgray;">●</span>
                                @endif
                        ...
                        <div class="post-data">
                            ...
                            @if(!$post->postMedia->isEmpty())
                                ...
                                @php
                                    ...
                                    $file_name = $post->postMedia[0]->name;
...
{{--                        {{dd($post->jobs)}}--}}
                     ...
                     @elseif($post->postType->name == 'Shared')
                        ...
                        <div class="job-post-data">
                               <!-- post header -->
                                <div class="post-author">
                                    @if ($post->shared->user->id == auth()->id())
                                        <a href="{{ route('profile') }}">
                                    @else
                                        <a href="{{ route('user.profile.show', $post->shared->user->id) }}">
                                    @endif
                                        <div class="author-details">
                                            <figure class="image-container">
...
{{--                                                  @if($reflection->user->isOnline() == true)--}}
{{--                                                      <span class="logged-in" style="position: relative; top: 15px; right: 24px; font-size: 21px; color: #5BE38F;">●</span>--}}
{{--                                                  @elseif($reflection->user->isOnline() != true)--}}
{{--                                                      <span class="logged-out" style="position: relative; top: 15px; right: 24px; font-size: 21px; color: darkgray;">●</span>--}}
{{--                                                  @endif--}}
                                          </figure>
...
{{--                                My Changes--}}
                                <a href="{{route('page.detail',$page->id)}}" style="background: none">
                                    ...
                                    @else
                                    <img src="{{asset("/assets/img")}}/page-icon.png" alt=""> </a>
                                    @endif
                                ...
                                @if( in_array($page->id,auth()->user()->pagesfollow->pluck("id")->toArray()) )
                                    ...
                                    <a  href="javascript:void(0)" class="unfollow_page btn-info btn-sm" data-page="{{$page->id}}">
                                        Un-Follow
                                    </a>
                ...
                <div class="right-sidebar">
                    ...
                    <div class="top-right-bar">
                        ...
                        @foreach($jobs as $job)
                            ...
                            @if($job->user_id != auth()->id() &&  $job->jobs != "")
