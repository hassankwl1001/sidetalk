                ...
                <div class="profile-review">
                    <div class="profile-points">
                        <ul>
                            ...
                            <li>
                                <img src="/public/assets/img/Group8.png" alt="">
                                <span>Reflects</span>
                    ...
                    <form class="login__form popup__form" action="{{ route('profile.update') }}" method="post">
                      ...
                      <div class="form__input--floating">
                        <div class="form__input--floating two-column-grid-first">
                            ...
                            <input id="input--first" type="text" placeholder="" value="{{ auth()->user()->firstname }}" name="firstname" required>
                        </div>
                        <div class="form__input--floating two-column-grid-second">
                            ...
                            <input id="input--last" type="text" placeholder="" value="{{ auth()->user()->lastname }}" name="lastname" required>
                        </div>
                      </div>
                      <div class="form__input--floating">
